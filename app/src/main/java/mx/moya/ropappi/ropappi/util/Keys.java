...
public class Keys {
    ...
    public static final String url_get_all_categories = "https://ropappi.azurewebsites.net/api/categories";
    public static final String url_get_products_by_category = "https://ropappi.azurewebsites.net/api/Categories/product/";
    public static final String url_get_detail_product = "https://ropappi.azurewebsites.net/api/productsapi/";
